!(function (t) {
  ...
  function (t, e, n) {
    ...
    if (n(11)) {
      var r = n(32),
        ...
        Rt = function (t, e) {
          return Mt(this, st.call(kt(this), t, e));
        },
        jt = function (t) {
          kt(this);
            ...
            ? ((h = n(function (t, n, r, o) {
                ...
                if (w(n)) {
                  if (
                    ...
                    return bt in n ? Pt(h, n) : Ot.call(h, n);
                  (i = n), (d = Et(r, e));
                  var y = n.byteLength;
                  if (void 0 === o) {
                    if (y % e) throw B('Wrong length!');
                    if ((u = y - d) < 0) throw B('Wrong length!');
                  } else if ((u = v(o) * e) + d > y) throw B('Wrong length!');
                  a = u / e;
                } else (a = m(n)), (i = new G((u = a * e)));
                for (
      ...
      function (t, e, n, s, p) {
        ...
        if (i(y)) {
          for (d = a(t.length); d > b; b++)
            if ((m = e ? g(u((h = t[b]))[0], h[1]) : g(t[b])) === c || m === f)
              return m;
        } else
    ...
    t.exports = function (t, e, n, v, m, y) {
      ...
      if (
        ...
        M ||
          ...
          (w.constructor = b)),
          (T || P) && (_('delete'), _('has'), m && _('get')),
          (P || k) && _(x),
          y && w.clear && delete w.clear;
      } else
        (b = v.getConstructor(e, t, m, x)), u(b.prototype, n), (a.NEED = !0);
      return (
        d(b, t),
        (S[t] = b),
        o(o.G + o.W + o.F * (b != g), S),
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n, h, v, m, y) {
      ...
      var g,
        ...
        M = T || w(v),
        P = v ? (_ ? w('entries') : M) : void 0,
        C = ('Array' == e && k.entries) || T;
      if (
        (C &&
          (x = f(C.call(new t()))) !== Object.prototype &&
          x.next &&
  ...
  function (t, e, n) {
    ...
    function I(t, e, n) {
      ...
      for (
        (t = T(t)) != t || t === E
          ...
          : ((r = P(C(t) / O)),
            t * (i = M(2, -r)) < 1 && (r--, (i *= 2)),
            (t += r + c >= 1 ? f / i : f * M(2, 1 - c)) * i >= 2 &&
              (r++, (i /= 2)),
            r + c >= l
              ? ((o = 0), (r = l))
              : r + c >= 1
              ? ((o = (t * i - 1) * M(2, e)), (r += c))
              : ((o = t * M(2, c - 1) * M(2, e)), (r = 0)));
        e >= 8;
        u[s++] = 255 & o, o /= 256, e -= 8
      );
    ...
    function q(t, e, n, r, o, i) {
      var u = d(+n);
      if (u + e > t[F]) throw _(b);
      for (var a = t[N]._b, l = u + t[A], c = r(+o), f = 0; f < e; f++)
        a[l + f] = c[i ? f : e - f - 1];
    }
    if (u.ABV) {
      if (
...
*/ var r = Object.getOwnPropertySymbols,
  ...
  function (t, e, n) {
    ...
    n(133);
    var r,
      o = (r = n(305)) && r.__esModule ? r : { default: r };
    ...
    var r = n(2),
      ...
      X = function (t) {
        for (var e, n = O(x(t)), r = [], i = 0; n.length > i; )
          o(D, (e = n[i++])) || e == I || e == l || r.push(e);
        return r;
      },
      J = function (t) {
        for (
          var e, n = t === U, r = O(n ? z : x(t)), i = [], u = 0;
          r.length > u;
    ...
    W ||
      (a(
        (N = function () {
          ...
          return i && B && q(U, t, { configurable: !0, set: e }), H(t);
        }).prototype,
        'toString',
        function () {
          return this._k;
          ...
          if ((l < 0 && ((v = '-'), (l = -l)), l > 1e-21))
            if (
              ...
              for (s(h(10, r, 1), 0), r = e - 1; r >= 23; )
                p(1 << 23), (r -= 23);
              p(1 << r), s(1, 1), p(2), (m = d());
            } else s(0, n), s(1 << -e, 0), (m = d() + u.call('0', c));
          return (m =
            c > 0
              ? v +
                ((a = m.length) <= c
      ...
      'Array',
      {
        from: function (t) {
          ...
          if (
            ...
            for (n = new d((e = l(p.length))); e > y; y++)
              c(n, y, m ? v(p[y], y) : p[y]);
          else
            for (s = g.call(p), n = new d(); !(o = s.next()).done; y++)
              c(n, y, m ? u(s, v, [o.value, y], !0) : o.value);
          return (n.length = y), n;
        },
      },
    );
  ...
  function (t, e, n) {
    var r = n(0);
    r(r.P, 'Array', { fill: n(82) }), n(38)('fill');
  },
  function (t, e, n) {
    'use strict';
    var r = n(0),
      ...
      return [
        ...
        function (t, e) {
          ...
          for (var g = []; ; ) {
            ...
            if (null === b) break;
            if ((g.push(b), !m)) break;
            '' === String(b[0]) && (s.lastIndex = a(p, i(s.lastIndex), y));
          }
          for (var x, w = '', S = 0, _ = 0; _ < g.length; _++) {
            b = g[_];
            for (
              var E = String(b[0]),
                k = c(f(u(b.index), p.length), 0),
                T = [],
                M = 1;
              M < b.length;
              M++
            )
              T.push(void 0 === (x = b[M]) ? x : String(x));
            var P = b.groups;
            if (d) {
              var C = [E].concat(T, k, p);
              void 0 !== P && C.push(P);
              var O = String(e.apply(void 0, C));
            } else O = v(E, p, k, T, P, e);
            k >= S && ((w += p.slice(S, k) + O), (S = k + E.length));
          }
          return w + p.slice(S);
        },
      ];
  ...
  function (t, e, n) {
    ...
    var r,
      ...
      b = (t.exports = n(60)('WeakMap', y, g, c, !0, !0));
    p &&
      d &&
  ...
  function (t, e, n) {
    var r = n(0);
    r(r.G + r.W + r.F * !n(61).ABV, { DataView: n(87).DataView });
  },
  function (t, e, n) {
  ...
  function (t, e, n) {
    ...
    t.exports = function t(e, n, l, c, f, s, p, d) {
      for (var h, v, m = f, y = 0, g = !!p && u(p, d, 3); y < c; ) {
        if (y in l) {
          if (
            ((h = g ? g(l[y], y, n) : l[y]),
            (v = !1),
  ...
  function (t, e, n) {
    n(291), (t.exports = n(64).f('asyncIterator'));
  },
  function (t, e, n) {
    n(92)('asyncIterator');
  },
  ...
  function (t, e, n) {
    'use strict';
    n(113), n(299), (t.exports = n(9).Promise.finally);
  },
  function (t, e, n) {
    'use strict';
    var r = n(0),
  ...
  function (t, e, n) {
    for (
      ...
      var m,
        ...
        b = u[y],
        x = b && b.prototype;
      if (x && (x[f] || a(x, f, p), x[s] || a(x, s, y), (l[y] = p), g))
  ...
  function (t, e, n) {
    ...
    function C(t, e, n) {
      ...
      if (null != e)
        ...
        e))
          M.call(e, r) && !P.hasOwnProperty(r) && (o[r] = e[r]);
  ...
  function (t, e, n) {
        ...
        for (var t in h) {
          ...
          if ((-1 < n || u('96', t), !y[n]))
            ...
            (n = e.eventTypes))) {
              ...
              if (c) {
                for (o in c) c.hasOwnProperty(o) && m(c[o], a, l);
                o = !0;
              } else
                i.registrationName
                  ? (m(i.registrationName, a, l), (o = !0))
                  : (o = !1);
              o || u('98', r, t);
            }
        }
    ...
    function U(t, e, n) {
      (e = O(t, n.dispatchConfig.phasedRegistrationNames[e])) &&
    ...
    function V(t, e, n) {
      t &&
        ...
        (e = O(t, n.dispatchConfig.registrationName)) &&
        ((n._dispatchListeners = k(n._dispatchListeners, e)),
        (n._dispatchInstances = k(n._dispatchInstances, t)));
    }
    function B(t) {
    ...
    var pt = lt.extend({ data: null }),
      ...
      mt = null;
    H && 'documentMode' in document && (mt = document.documentMode);
    var yt = H && 'TextEvent' in window && !mt,
      gt = H && (!vt || (mt && 8 < mt && 11 >= mt)),
        ...
        extractEvents: function (t, e, n, r) {
          ...
          return (
            o
              ? (gt &&
                  'ko' !== n.locale &&
                  (Et || o !== xt.compositionStart
                    ? o === xt.compositionEnd && Et && (i = it())
            ...
            (t = yt
              ...
              ? (((e = dt.getPooled(xt.beforeInput, e, n, r)).data = t), q(e))
              : (e = null),
    ...
    function Ot(t) {
      Mt ? (Pt ? Pt.push(t) : (Pt = [t])) : (Mt = t);
    }
    function Nt() {
      if (Mt) {
        var t = Mt,
          e = Pt;
        if (((Pt = Mt = null), Ct(t), e))
    ...
    var Ht = /^(.*)[\\\/]/,
      ...
      Gt = $t ? Symbol.for('react.element') : 60103,
      Qt = $t ? Symbol.for('react.portal') : 60106,
      Yt = $t ? Symbol.for('react.fragment') : 60107,
      Kt = $t ? Symbol.for('react.strict_mode') : 60108,
      Xt = $t ? Symbol.for('react.profiler') : 60114,
    ...
    function Se(t, e) {
      ...
      e.hasOwnProperty('value')
        ? Ee(t, e.type, n)
        : e.hasOwnProperty('defaultValue') && Ee(t, e.type, ge(e.defaultValue)),
        null == e.checked &&
    ...
    function Te(t, e, n) {
      return (
        ((t = lt.getPooled(ke.change, t, e, n)).type = 'change'), Ot(n), q(t), t
      );
    }
    var Me = null,
      Pe = null;
    ...
    var Fe = !1;
    function Ae() {
      Me && (Me.detachEvent('onpropertychange', Ie), (Pe = Me = null));
    }
    function Ie(t) {
      'value' === t.propertyName && Oe(Pe) && jt(Ce, (t = Te(Pe, t, zt(t))));
    }
    function Re(t, e, n) {
      'focus' === t
        ? (Ae(), (Pe = n), (Me = e).attachEvent('onpropertychange', Ie))
        : 'blur' === t && Ae();
    }
    function je(t) {
      ...
      Xe = {
        ...
        extractEvents: function (t, e, n, r) {
          ...
          if (
            ...
            i
              ? ((i = e),
                (e = (e = n.relatedTarget || n.toElement) ? R(e) : null))
              : (i = null),
            i === e)
          )
            return null;
    ...
    function _n(t) {
      ...
      for (n = 0; n < t.ancestors.length; n++) {
        ...
        r = t.topLevelType;
        for (var i = t.nativeEvent, u = null, a = 0; a < y.length; a++) {
          var l = y[a];
          l && (l = l.extractEvents(r, e, i, o)) && (u = k(u, l));
        }
        N(u);
      }
    }
    ...
    function Lr(t, e, n) {
      Or.current !== Cr && u('168'), Pr(Or, e), Pr(Nr, n);
    }
    function Dr(t, e, n) {
      var r = t.stateNode;
    ...
    function Qr(t, e, n, r, o, i) {
      var a = 2;
      if (((r = t), 'function' == typeof t)) $r(t) && (a = 1);
        ...
        t: switch (t) {
          ...
          case Xt:
            return (
              ((t = Hr(12, n, e, 4 | o)).elementType = Xt),
              (t.type = Xt),
              (t.expirationTime = i),
              t
            );
    ...
    var uo = {
      ...
      enqueueForceUpdate: function (t, e) {
        ...
        var n = Sa(),
          r = Ki((n = Yu(n, t)));
        (r.tag = Hi), null != e && (r.callback = e), Bu(), Ji(t, r), Ju(t, n);
      },
    };
    ...
    function lo(t, e, n) {
      ...
      return (
        'object' == typeof i && null !== i
          ? (i = Vi(i))
          : ((o = Ir(e) ? Fr : Or.current),
            (i = (r = null != (r = e.contextTypes)) ? Ar(t, o) : Cr)),
        (e = new e(n, i)),
        (t.memoizedState =
    ...
    function fo(t, e, n, r) {
      ...
      'object' == typeof i && null !== i
        ? (o.context = Vi(i))
        : ((i = Ir(e) ? Fr : Or.current), (o.context = Ar(t, i))),
    ...
    function vo(t) {
      ...
      function v(o, u, a, l) {
        ...
        for (s = r(o, s); v < a.length; v++)
          (m = h(s, o, v, a[v], l)) &&
            (t && null !== m.alternate && s.delete(null === m.key ? v : m.key),
            (u = i(m, u, v)),
      ...
      function m(o, a, l, c) {
        ...
        for (v = r(o, v); !g.done; m++, g = l.next())
          null !== (g = h(v, o, m, g.value, c)) &&
            (t && null !== g.alternate && v.delete(null === g.key ? m : g.key),
            (a = i(g, a, m)),
            null === s ? (f = g) : (s.sibling = g),
            (s = g));
        return (
    ...
    function oi(t, e, n, r) {
      var o = Zo();
      (Ho |= t), (o.memoizedState = ri(e, n, void 0, void 0 === r ? null : r));
    }
    function ii(t, e, n, r) {
      var o = ti();
      r = void 0 === r ? null : r;
      ...
      if (null !== Do) {
        ...
        if (((i = u.destroy), null !== r && Ko(r, u.deps)))
          return void ri(Mo, n, i, r);
      }
      (Ho |= t), (o.memoizedState = ri(e, n, i, r));
    }
    function ui(t, e) {
        ...
        if (
          ...
          try {
            var c = e.lastRenderedState,
              f = r(c, n);
            if (((i.eagerReducer = r), (i.eagerState = f), Je(f, c))) return;
          } catch (t) {}
        Ju(t, o);
      }
    }
    var ci = {
        ...
        useContext: Vi,
        useEffect: function (t, e) {
          return oi(516, Io | Ao, t, e);
        },
        useImperativeHandle: function (t, e, n) {
          return (
            (n = null != n ? n.concat([t]) : null),
            oi(4, Co | Fo, ui.bind(null, e, t), n)
          );
        },
        useLayoutEffect: function (t, e) {
          return oi(4, Co | Fo, t, e);
        },
        useMemo: function (t, e) {
          var n = Zo();
          return (
      ...
      si = {
        ...
        useContext: Vi,
        useEffect: function (t, e) {
          return ii(516, Io | Ao, t, e);
        },
        useImperativeHandle: function (t, e, n) {
          return (
            (n = null != n ? n.concat([t]) : null),
            ii(4, Co | Fo, ui.bind(null, e, t), n)
          );
        },
        useLayoutEffect: function (t, e) {
          return ii(4, Co | Fo, t, e);
        },
        useMemo: function (t, e) {
          var n = ti();
          e = void 0 === e ? null : e;
    ...
    var wi = qt.ReactCurrentOwner,
      Si = !1;
    function _i(t, e, n, r) {
      e.child = null === t ? yo(e, null, n, r) : mo(e, t.child, n, r);
    }
          ...
          a !== r || l !== p || Nr.current || Gi
            ...
            : ('function' != typeof u.componentDidUpdate ||
              ...
              'function' != typeof u.getSnapshotBeforeUpdate ||
                ...
                (e.effectTag |= 256),
              (r = !1));
      return Oi(t, e, n, r, i, o);
    }
    function Oi(t, e, n, r, o, i) {
      Mi(t, e);
      var u = 0 != (64 & e.effectTag);
      if (!r && !u) return o && Ur(e, n, !1), Ai(t, e, i);
      ...
      return (
        (e.effectTag |= 1),
        null !== t && u
          ? ((e.child = mo(e, t.child, null, i)), (e.child = mo(e, null, a, i)))
          : _i(t, e, a, i),
      ...
      switch (((e.expirationTime = 0), e.tag)) {
            ...
            (r = e.memoizedState.element) === o
              ...
              : ((o = e.stateNode),
                (o = (null === t || null === t.child) && o.hydrate) &&
                  ((di = Er(e.stateNode.containerInfo)),
                  (pi = e),
                  (o = hi = !0)),
                o
        ...
        case 4:
          return (
            _o(e, e.stateNode.containerInfo),
            (r = e.pendingProps),
            null === t ? (e.child = mo(e, null, r, n)) : _i(t, e, r, n),
            e.child
          );
        case 11:
          return (
            (r = e.type),
            (o = e.pendingProps),
            Ei(t, e, r, (o = e.elementType === r ? o : ro(r, o)), n)
          );
        case 7:
    ...
    function zi(t, e) {
      ...
      Pr(Ri, n._currentValue), (n._currentValue = e);
    }
    function Ui(t) {
      var e = Ri.current;
      Mr(Ri), (t.type._context._currentValue = e);
    }
    function Wi(t, e) {
      (ji = t), (Di = Li = null);
    ...
    function hu(t, e, n) {
      if (null !== (n = null !== (n = n.updateQueue) ? n.lastEffect : null)) {
        ...
        do {
          ...
          (r.tag & e) !== Mo && ((o = r.create), (r.destroy = o())),
            (r = r.next);
        } while (r !== n);
      }
    }
              ...
              n.forEach(function (t) {
                var n = function (t, e) {
                  ...
                  null !== n && n.delete(e),
                    (e = Yu((e = Sa()), t)),
                    null !== (t = Xu(t, e)) &&
                      (Zr(t, e), 0 !== (e = t.expirationTime) && _a(t, e));
                }.bind(null, e, t);
    ...
    var Eu = qt.ReactCurrentDispatcher,
      ku = qt.ReactCurrentOwner,
      Tu = 1073741822,
      Mu = !1,
      Pu = null,
      Cu = null,
    ...
    function zu() {
      ...
      (Cu = null), (Ou = 0), (Nu = -1), (Fu = !1), (Pu = null);
    }
    function Uu() {
      for (; null !== Au; ) {
        var t = Au.effectTag;
        ...
        switch (14 & t) {
          case 2:
            yu(Au), (Au.effectTag &= -3);
            break;
          case 6:
            yu(Au), (Au.effectTag &= -3), bu(Au.alternate, Au);
            break;
          case 4:
            bu(Au.alternate, Au);
            break;
    ...
    function Vu(t, e) {
      for (; null !== Au; ) {
        ...
        128 & n &&
          null !== (o = Au.ref) &&
          ((i = Au.stateNode), 'function' == typeof o ? o(i) : (o.current = i)),
          512 & n && (Ru = t),
          (Au = Au.nextEffect);
      }
    }
    ...
    function qu(t, e) {
      ...
      for (
        Dn(mr), mr = null, En = !!vr, vr = null, t.current = e, Au = r;
        null !== Au;
    ...
    function Hu(t) {
      for (;;) {
        ...
        if (0 == (1024 & t.effectTag)) {
                ...
                if (((a = e.type), null !== i && null != e.stateNode))
                  ...
                  if (bi(e)) {
                    ...
                    var s = l.type,
                      p = l.memoizedProps,
                      d = c;
                    switch (((i[A] = l), (i[I] = p), (a = void 0), (c = s))) {
                      case 'iframe':
                      case 'object':
                        kn('load', i);
                        break;
                      case 'video':
                      case 'audio':
                        for (s = 0; s < et.length; s++) kn(et[s], i);
                        break;
                      case 'source':
                        kn('error', i);
                        break;
                      ...
                      case 'details':
                        ...
                        break;
                      case 'input':
                        xe(i, p), kn('invalid', i), dr(d, 'onChange');
                        break;
                      case 'select':
                        ...
                        break;
                      case 'textarea':
                        Kn(i, p), kn('invalid', i), dr(d, 'onChange');
                    }
          ...
          if (((e = t), 1 === Ou || 1 !== e.childExpirationTime)) {
    ...
    function Gu(t, e) {
      ...
      (r === Ou && t === Cu && null !== Pu) ||
        (zu(),
        (Ou = r),
        (Pu = Gr((Cu = t).current, null)),
        (t.pendingCommitExpirationTime = 0));
      for (var o = !1; ; ) {
        try {
          if (e) for (; null !== Pu && !Ta(); ) Pu = $u(Pu);
          else for (; null !== Pu; ) Pu = $u(Pu);
        } catch (e) {
          if (((Di = Li = ji = null), Jo(), null === Pu)) (o = !0), Fa(e);
          else {
            null === Pu && u('271');
            var i = Pu,
              a = i.return;
      ...
      if (((Mu = !1), (Eu.current = n), (Di = Li = ji = null), Jo(), o))
        (Cu = null), (t.finishedWork = null);
      else if (null !== Pu) t.finishedWork = null;
      else {
        if ((null === (n = t.current.alternate) && u('281'), (Cu = null), Fu)) {
          if (
        ...
        switch (n.tag) {
          case 1:
            ...
            if (
              ...
              return (
                Ji(n, (t = Su(n, (t = iu(e, t)), 1073741823))),
    ...
    function Ju(t, e) {
      null !== (t = Xu(t, e)) &&
        (!Mu && 0 !== Ou && e > Ou && zu(),
        Zr(t, e),
        (Mu && !Iu && Cu === t) || _a(t, t.expirationTime),
        ya > ma && ((ya = 0), u('185')));
    }
    ...
    function xa(t, e) {
      ...
      (na = e),
        (t = i.unstable_now() - da),
        (ra = i.unstable_scheduleCallback(Ma, {
    ...
    function Sa() {
      return oa ? va : (Ea(), (0 !== ua && 1 !== ua) || (ba(), (va = ha)), va);
    }
    function _a(t, e) {
      null === t.nextScheduledRoot
        ...
        oa ||
          (fa
            ? sa && ((ia = t), (ua = 1073741823), Oa(t, 1073741823, !1))
            : 1073741823 === e
            ? Pa(1073741823, !1)
            : xa(t, e));
    }
    ...
    var ka = !1;
    function Ta() {
      return !!ka || (!!i.unstable_shouldYield() && (ka = !0));
    }
    function Ma() {
      try {
        if (!Ta() && null !== ta) {
    ...
    function Pa(t, e) {
      if ((Ea(), e))
        for (
          ba(), va = ha;
          null !== ia && 0 !== ua && t <= ua && !(ka && ha > ua);

        )
          Oa(ia, ua, ha > ua), Ea(), ba(), (va = ha);
      else for (; null !== ia && 0 !== ua && t <= ua; ) Oa(ia, ua, !1), Ea();
      if (
        (e && ((na = 0), (ra = null)),
        0 !== ua && xa(ia, ua),
        (ya = 0),
    ...
    function Ca(t, e) {
      oa && u('253'), (ia = t), (ua = e), Oa(t, e, !1), Pa(1073741823, !1);
    }
    function Oa(t, e, n) {
      if ((oa && u('245'), (oa = !0), n)) {
    ...
    var Ha = {
      ...
      hydrate: function (t, e, n) {
        return Va(e) || u('200'), Ba(null, t, e, !0, n);
      },
      render: function (t, e, n) {
        return Va(e) || u('200'), Ba(null, t, e, !1, n);
      },
  ...
  function (t, e, n) {
    ...
    (function (t) {
      ...
      if (
        ...
        (S = function (t) {
          null !== M ? setTimeout(S, 0, t) : ((M = t), setTimeout(P, 0, !1));
        }),
          (_ = function () {
            M = null;
          }),
        ...
        (S = function (t, e) {
          (C = t),
            (N = e),
            A || 0 > e ? D.postMessage(void 0) : F || ((F = !0), x(z));
        }),
          (_ = function () {
            (C = null), (O = !1), (N = -1);
          });
  ...
  function (t, e, n) {
    ...
    n.r(u),
      ...
      n.d(u, 'transformMat2', function () {
        return Te;
      }),
      n.d(u, 'transformMat2d', function () {
        return Me;
      }),
    ...
    function M(t, e) {
      return Math.abs(t - e) <= w * Math.max(1, Math.abs(t), Math.abs(e));
    }
    function P() {
      var t = new S(9);
      return (
    ...
    function A(t, e, n, r, o, i, u, a, l, c) {
      return (
        (t[0] = e),
        (t[1] = n),
        (t[2] = r),
    ...
    function rt(t, e) {
      var n = t[0],
        ...
        b = e[8];
      return (
        Math.abs(n - s) <= w * Math.max(1, Math.abs(n), Math.abs(s)) &&
        Math.abs(r - p) <= w * Math.max(1, Math.abs(r), Math.abs(p)) &&
        Math.abs(o - d) <= w * Math.max(1, Math.abs(o), Math.abs(d)) &&
        Math.abs(i - h) <= w * Math.max(1, Math.abs(i), Math.abs(h)) &&
        Math.abs(u - v) <= w * Math.max(1, Math.abs(u), Math.abs(v)) &&
        Math.abs(a - m) <= w * Math.max(1, Math.abs(a), Math.abs(m)) &&
        Math.abs(l - y) <= w * Math.max(1, Math.abs(l), Math.abs(y)) &&
        Math.abs(c - g) <= w * Math.max(1, Math.abs(c), Math.abs(g)) &&
        Math.abs(f - b) <= w * Math.max(1, Math.abs(f), Math.abs(b))
      );
    }
    var ot = z,
      it = Z;
    ...
    function ct(t, e, n, r, o, i, u, a, l, c, f, s, p, d, h, v) {
      var m = new S(16);
      return (
        (m[0] = t),
        (m[1] = e),
    ...
    function ft(t, e, n, r, o, i, u, a, l, c, f, s, p, d, h, v, m) {
      return (
        (t[0] = e),
        (t[1] = n),
        (t[2] = r),
    ...
    function mt(t, e, n) {
      ...
      return (
        ...
        (t[13] = b * o + x * l + w * p + S * m),
        (t[14] = b * i + x * c + w * d + S * y),
    ...
    function yt(t, e, n) {
      ...
      return (
        e === t
          ? ((t[12] = e[0] * v + e[4] * m + e[8] * y + e[12]),
            (t[13] = e[1] * v + e[5] * m + e[9] * y + e[13]),
            (t[14] = e[2] * v + e[6] * m + e[10] * y + e[14]),
            (t[15] = e[3] * v + e[7] * m + e[11] * y + e[15]))
          : ((r = e[0]),
            (o = e[1]),
            (i = e[2]),
            (u = e[3]),
            ...
            (t[10] = d),
            (t[11] = h),
            (t[12] = r * v + a * m + s * y + e[12]),
            (t[13] = o * v + l * m + p * y + e[13]),
            (t[14] = i * v + c * m + d * y + e[14]),
            (t[15] = u * v + f * m + h * y + e[15])),
        t
      );
    }
    function gt(t, e, n) {
    ...
    function Rt(t, e, n, r, o) {
      ...
      return (
        ...
        (t[10] = R),
        (t[11] = 0),
        (t[12] = n[0] + E - (M * E + O * k + A * T)),
        (t[13] = n[1] + k - (P * E + N * k + I * T)),
        (t[14] = n[2] + T - (C * E + F * k + R * T)),
        (t[15] = 1),
        t
      );
    }
    ...
    function Wt(t, e, n, r) {
      var o,
        ...
        S = n[1],
        _ = n[2];
      return Math.abs(h - x) < w && Math.abs(v - S) < w && Math.abs(m - _) < w
        ? st(t)
        : ((f = h - x),
          (s = v - S),
          (p = m - _),
    ...
    function Kt(t, e) {
      var n = t[0],
        ...
        I = e[15];
      return (
        Math.abs(n - g) <= w * Math.max(1, Math.abs(n), Math.abs(g)) &&
        Math.abs(r - b) <= w * Math.max(1, Math.abs(r), Math.abs(b)) &&
        Math.abs(o - x) <= w * Math.max(1, Math.abs(o), Math.abs(x)) &&
        Math.abs(i - S) <= w * Math.max(1, Math.abs(i), Math.abs(S)) &&
        Math.abs(u - _) <= w * Math.max(1, Math.abs(u), Math.abs(_)) &&
        Math.abs(a - E) <= w * Math.max(1, Math.abs(a), Math.abs(E)) &&
        Math.abs(l - k) <= w * Math.max(1, Math.abs(l), Math.abs(k)) &&
        Math.abs(c - T) <= w * Math.max(1, Math.abs(c), Math.abs(T)) &&
        Math.abs(f - M) <= w * Math.max(1, Math.abs(f), Math.abs(M)) &&
        Math.abs(s - P) <= w * Math.max(1, Math.abs(s), Math.abs(P)) &&
        Math.abs(p - C) <= w * Math.max(1, Math.abs(p), Math.abs(C)) &&
        Math.abs(d - O) <= w * Math.max(1, Math.abs(d), Math.abs(O)) &&
        Math.abs(h - N) <= w * Math.max(1, Math.abs(h), Math.abs(N)) &&
        Math.abs(v - F) <= w * Math.max(1, Math.abs(v), Math.abs(F)) &&
        Math.abs(m - A) <= w * Math.max(1, Math.abs(m), Math.abs(A)) &&
        Math.abs(y - I) <= w * Math.max(1, Math.abs(y), Math.abs(I))
      );
    }
    var Xt = mt,
      Jt = $t;
    function Zt() {
      var t = new S(2);
      return S != Float32Array && ((t[0] = 0), (t[1] = 0)), t;
    }
    function te(t) {
      var e = new S(2);
    ...
    function Re(t, e) {
      var n = t[0],
        ...
        i = e[1];
      return (
        Math.abs(n - o) <= w * Math.max(1, Math.abs(n), Math.abs(o)) &&
        Math.abs(r - i) <= w * Math.max(1, Math.abs(r), Math.abs(i))
      );
    }
    var je,
      Le = ye,
    ...
    function He() {
      var t = new S(3);
      return S != Float32Array && ((t[0] = 0), (t[1] = 0), (t[2] = 0)), t;
    }
    function $e(t) {
      var e = new S(3);
    ...
    function Nn(t, e) {
      var n = t[0],
        ...
        a = e[2];
      return (
        Math.abs(n - i) <= w * Math.max(1, Math.abs(n), Math.abs(i)) &&
        Math.abs(r - u) <= w * Math.max(1, Math.abs(r), Math.abs(u)) &&
        Math.abs(o - a) <= w * Math.max(1, Math.abs(o), Math.abs(a))
      );
    }
    var Fn = Je,
      An = Ze,
      ...
      Wn = 'PRE',
      Vn =
        (x.a.shape({ x: x.a.number, y: x.a.number }),
        x.a.shape({ x: x.a.number, y: x.a.number, z: x.a.number })),
      Bn = x.a.instanceOf(r.ARRAY_TYPE);
    function qn(t, e) {
      return (
        (function (t) {
    ...
    function Hn(t, e) {
      var n =
        ...
        l = o,
        c = i;
      if (!e) return a.set(t, u, l, c);
      if ('number' == typeof e) (u = e), (l = e), (c = e);
      else if (
    ...
    var $n = (function (t) {
      function e() {
        ...
        return (
          (r = this),
          (o = (t = y(e)).call.apply(t, [this].concat(l))),
          ((n =
            !o || ('object' !== v(o) && 'function' != typeof o)
              ? m(r)
              : o).matrix = i.create()),
          (n.matrixWorld = i.create()),
          (n.vTranslation = a.create()),
          (n.vScale = a.create()),
          (n.vRotationAxis = a.create()),
          (n.renderChild = function (t) {
            var e = n.props.multiplicationOrder,
              r = m(n).matrixWorld,
              o = {
                style: p({}, t.props.style || {}, {
        ...
        (r = [
          {
            ...
            value: function () {
              var t = this.props,
                ...
                p = this.vTranslation,
                d = this.vScale,
                h = this.vRotationAxis,
                v = 'number' == typeof u ? u : 0;
              return (
                i.identity(f),
                Hn(p, o),
                Hn(d, l, 1, 1, 1),
                ...
                'function' == typeof e
                  ...
                  : c.a.Children.map(e, this.renderChild)
              );
            },
          },
        ]) && d(n.prototype, r),
    ...
    ($n.propTypes = {
      parentMatrixWorld: Bn,
      multiplicationOrder: x.a.oneOf([Wn, Un]),
      translate: x.a.oneOfType([Bn, Vn]),
      scale: x.a.oneOfType([Bn, Vn, x.a.number]),
      rotate: x.a.number,
      rotateAxis: x.a.oneOfType([Bn, Vn]),
      children: x.a.oneOfType([x.a.node, x.a.func]).isRequired,
    }),
      ($n.defaultProps = {
        parentMatrixWorld: i.create(),
        multiplicationOrder: Un,
    ...
    var tr = (function (t) {
        function e(t) {
          ...
          !(function (t, e) {
            ...
            ((n = Kn(this, Xn(e).call(this, t))).position = a.create()),
            (n.normal = a.fromValues(0, 0, 1)),
            (n.positionToLight = a.create()),
            (n.worldNormal = a.create()),
            (n.normalMatrix = o.create()),
            (n.lightPos = a.create());
          var r,
            i,
            u = t.color,
          ...
          return (
            (n.colorRgb = l),
            (n.shadowColorRgb = Zn(n.colorRgb, [0, 0, 0], 0.333)),
            n
          );
        }
        var n, r, i;
          ...
          (r = [
            {
              ...
              value: function () {
                var t = this.props,
                  ...
                  u = this.normal,
                  l = this.normalMatrix,
                  f = this.positionToLight,
                  s = this.worldNormal,
                  p = this.shadowColorRgb,
                  d = this.colorRgb,
                  h = this.lightPos;
                a.set(h, window.innerWidth / 3, window.innerHeight / 3, 0),
                  o.normalFromMat4(l, e),
                  a.transformMat3(s, u, l),
                  a.transformMat4(f, i, e),
                  a.sub(f, h, f),
                  a.normalize(f, f);
                var v,
                  m,
                  ...
                  b = Zn(
                    ...
                    (m = 0),
                    (y = 1),
                    Math.min(Math.max(v, m), y)),
                  ),
                  x = Qn({}, n.props.style || {}, r, {
                    backgroundColor:
                      ((g = b),
                      'rgb('.concat(
                        g
                ...
                return c.a.cloneElement(n, { style: x });
              },
            },
          ]) && Yn(n.prototype, r),
          i && Yn(n, i),
      ...
      er = Math.PI / 2,
      nr = a.fromValues(1, 0, 0),
      rr = a.fromValues(0, 1, 0),
      or = a.fromValues(0, 0, 1);
    function ir(t) {
      return (ir =
        'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
          ? function (t) {
    ...
    var sr = (function (t) {
      function e() {
        ...
        for (var r = arguments.length, o = new Array(r), i = 0; i < r; i++)
          o[i] = arguments[i];
        return (
          ((n = lr(this, (t = cr(e)).call.apply(t, [this].concat(o)))).pos1 =
            a.create()),
          (n.pos2 = a.create()),
          (n.pos3 = a.create()),
          (n.pos4 = a.create()),
            ...
            value: function () {
              ...
              return (
                ...
                c.a.createElement(
                  ...
                  c.a.createElement(
                    $n,
                    { translate: o, rotate: -er, rotateAxis: rr },
                    c.a.createElement(
                      tr,
                      { color: n },
                      c.a.createElement('div', { style: d, className: 'face' }),
                    ),
                  ),
                  c.a.createElement(
                    $n,
                    { translate: i, rotate: er, rotateAxis: rr },
                    c.a.createElement(
                      tr,
                      { color: n },
                      c.a.createElement('div', { style: d, className: 'face' }),
                  ...
                  c.a.createElement(
                    $n,
                    { translate: u, rotate: er, rotateAxis: nr },
                    c.a.createElement(
                      tr,
                      { color: n },
                      c.a.createElement('div', { style: d, className: 'face' }),
                  ...
                  c.a.createElement(
                    $n,
                    { translate: l, rotate: -er, rotateAxis: nr },
                    c.a.createElement(
                      tr,
                      { color: n },
                      c.a.createElement('div', { style: d, className: 'face' }),
                  ...
                  c.a.createElement(
                    $n,
                    { translate: f, rotate: Math.PI, rotateAxis: rr },
                    c.a.createElement(
                      tr,
                      { color: n },
                      c.a.createElement('div', { style: d, className: 'face' }),
    ...
    var yr = (function (t) {
      function e() {
        ...
        return (
          ((n = hr(
            this,
            (t = vr(e)).call.apply(t, [this].concat(o)),
          )).cube1Translate = a.create()),
          (n.cube2Translate = a.create()),
          (n.cube3Translate = a.create()),
          (n.cube4Translate = a.create()),
          (n.cube5Translate = a.create()),
          (n.cube6Translate = a.create()),
          n
        );
      }
      var n, r, o;
        ...
        (r = [
          {
            ...
            value: function () {
              var t = this.props,
                ...
                l = this.cube4Translate,
                f = this.cube5Translate,
              ...
              return (
                ...
                c.a.createElement(
                  ...
                  c.a.createElement(
                    $n,
                    { parentMatrixWorld: n, rotate: p, rotateAxis: rr },
                    c.a.createElement(sr, {
                      parentMatrixWorld: n,
                      faceSize: r,
                      translate: u,
    ...
    var Er = (function (t) {
        function e() {
          ...
          for (var r = arguments.length, o = new Array(r), i = 0; i < r; i++)
            o[i] = arguments[i];
          return (
            ((n = wr(this, (t = Sr(e)).call.apply(t, [this].concat(o)))).state =
              {
            ...
            (n.translateToCentre = a.create()),
            (n.cubeGroup1Translate = a.create()),
            (n.cubeGroup2Translate = a.create()),
            (n.handleKeyUp = function (t) {
              32 === t.keyCode &&
                n.setState(function (t) {
                  return br({}, t, { playing: !t.playing });
                });
            }),
              ...
              value: function () {
                ...
                return (
                  ...
                  c.a.createElement(
                    ...
                    c.a.createElement(
                      $n,
                      { translate: i, rotate: f, rotateAxis: rr },
                      c.a.createElement(
                        $n,
                        { rotate: f, rotateAxis: or },
                        c.a.createElement(
                          $n,
                          { translate: u },
                          c.a.createElement(yr, { cubeFaceSize: s, time: e }),
                        ),
                        c.a.createElement(
                          $n,
                          { translate: l },
      ...
      kr = document.getElementById('root');
    s.a.render(c.a.createElement(Er, null), kr);
  },
]);
