...
import { vec2Obj, vec3Obj, vec2GlMatrix, vec3GlMatrix, mat2dGlMatrix, mat4GlMatrix } from '../src/constants';
...
describe('vec2Obj', () => {
  ...
  Object.keys(types).forEach(key => {
    it(`returns an error when passed ${key}`, () => {
      ...
      expect(vec2Obj({ foo: types[key] }, 'foo', COMPONENT_NAME)).toEqual(expected);
    });
  });
});
...
describe('vec3Obj', () => {
  ...
  Object.keys(types).forEach(key => {
    it(`returns an error when passed ${key}`, () => {
      ...
      expect(vec3Obj({ foo: types[key] }, 'foo', COMPONENT_NAME)).toEqual(expected);
    });
  });
});
...
describe('vec2GlMatrix', () => {
  it('returns null when passed a vec2', () => {
    expect(vec2GlMatrix({ foo: vec2.create() }, 'foo', COMPONENT_NAME)).toEqual(null);
  });
  ...
  Object.keys(types).forEach(key => {
    it(`returns an error when passed ${key}`, () => {
      ...
      expect(vec2GlMatrix({ foo: types[key] }, 'foo', COMPONENT_NAME)).toEqual(expected);
    });
  });
});
...
describe('vec3GlMatrix', () => {
  it('returns null when passed a vec3', () => {
    expect(vec3GlMatrix({ foo: vec3.create() }, 'foo', COMPONENT_NAME)).toEqual(null);
  });
  ...
  Object.keys(types).forEach(key => {
    it(`returns an error when passed ${key}`, () => {
      ...
      expect(vec3GlMatrix({ foo: types[key] }, 'foo', COMPONENT_NAME)).toEqual(expected);
    });
  });
});
...
describe('mat2GlMatrix', () => {
  it('returns null when passed a mat2d', () => {
    expect(mat2dGlMatrix({ foo: mat2d.create() }, 'foo', COMPONENT_NAME)).toEqual(null);
  });
  ...
  Object.keys(types).forEach(key => {
    it(`returns an error when passed ${key}`, () => {
      ...
      expect(mat2dGlMatrix({ foo: types[key] }, 'foo', COMPONENT_NAME)).toEqual(expected);
    });
  });
});
...
describe('mat4GlMatrix', () => {
  it('returns null when passed a mat4', () => {
    expect(mat4GlMatrix({ foo: mat4.create() }, 'foo', COMPONENT_NAME)).toEqual(null);
  });
  ...
  Object.keys(types).forEach(key => {
    it(`returns an error when passed ${key}`, () => {
      ...
      expect(mat4GlMatrix({ foo: types[key] }, 'foo', COMPONENT_NAME)).toEqual(expected);
    });
  });
});
